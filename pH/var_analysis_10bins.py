...
for i in mean_sorted_idx:
    if mean_var_np[i] <= mean_10_val:
        print(strain[i] + '\t' + str(j), file=p10_mean_f)
    elif mean_var_np[i] <= mean_20_val:
        print(strain[i] + '\t' + str(j), file=p20_mean_f)
    elif mean_var_np[i] <= mean_30_val:
        print(strain[i] + '\t' + str(j), file=p30_mean_f)
    elif mean_var_np[i] <= mean_40_val:
        print(strain[i] + '\t' + str(j), file=p40_mean_f)
    elif mean_var_np[i] <= mean_50_val:
        print(strain[i] + '\t' + str(j), file=p50_mean_f)
    elif mean_var_np[i] <= mean_60_val:
        print(strain[i] + '\t' + str(j), file=p60_mean_f)
    elif mean_var_np[i] <= mean_70_val:
        print(strain[i] + '\t' + str(j), file=p70_mean_f)
    elif mean_var_np[i] <= mean_80_val:
        print(strain[i] + '\t' + str(j), file=p80_mean_f)
    elif mean_var_np[i] <= mean_90_val:
        print(strain[i] + '\t' + str(j), file=p90_mean_f)
    else:
        print(strain[i] + '\t' + str(j), file=p100_mean_f)
    j = j + 1
