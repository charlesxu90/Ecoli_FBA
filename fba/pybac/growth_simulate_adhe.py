...
Gene_Reacts = AutoVivification()

#ADHE b1241 knockout
#1. ACALD (b0351 or b1241)
#2. ALCD2x (b1478 or b1241 or b0356)
Gene_Reacts['ADHE']['ACALD'] = 1 / 2
Gene_Reacts['ADHE']['ALCD2x'] = 1 / 3

for genes in Gene_Reacts:
    for rxn in Gene_Reacts[genes]:
        print (rxn, file=sys.stdout)
        react = cobra_model.reactions.get_by_id(rxn)
        react.upper_bound = Gene_Reacts[genes][rxn] * react.upper_bound
